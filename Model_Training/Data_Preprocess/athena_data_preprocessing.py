...
image_path = glob.glob("%s/*.png" % path)
...
def create_train_data(image_path_list):
    """
    Function to generate data for training
    
    Input: image_path_list
...
# load data
file_df, new_df, filename,cancer, name_cancer_dic, name_view_dic= load_data()

# load implant list
implant_list = load_implant_list()
...
# create data 
image_list, label_list, name_list, label_list_implant, image_list_implant = create_train_data(image_path)
