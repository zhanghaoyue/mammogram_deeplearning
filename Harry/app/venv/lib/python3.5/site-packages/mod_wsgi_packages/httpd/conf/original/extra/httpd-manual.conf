...
AliasMatch ^/manual(?:/(?:da|de|en|es|fr|ja|ko|pt-br|ru|tr|zh-cn))?(/.*)?$ "/tmp/pip-install-6ge85k2c/mod-wsgi-httpd/build/httpd/manual$1"

<Directory "/tmp/pip-install-6ge85k2c/mod-wsgi-httpd/build/httpd/manual">
    Options Indexes
    AllowOverride None
    Require all granted
