        ...
        var r = function() {
            ...
            h = function() {
                function e(t) {
                    var n = this;
                    o(this, e), 
		    this.mode = t.Tooltip.toUpperCase(), 
		    this.btn = new a.Button((0, a.extend)({
                        onClick: this.onClick
                    }, t)), 
		    s.default.getMode() === this.mode && this.activate(), 
		    s.default.addHandler("CHANGE_EVENT", function() {
    ...
    function(e, t, n) {
        ...
        function i(e, t, n, i) {
		    ...
		    n.dispatch({
                        ...
                        annotation: o.getPath(e, t, event)
                    })
